...
train_dat = readmatrix(strjoin(["../../Input_Data/Train_Val_Data/X_val_temp_",site,".csv"],''));
train_dat(train_dat==-9999) = nan;
temp = readtable(strjoin(["../../Input_Data/Train_Val_Data/X_val_temp_",site,".csv"],''));
...
writetable(data, strjoin(["Output/Out_SW_",site,"_emp_val.csv"],''))